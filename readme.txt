...
Yes, you can use with any theme or plugins. There is an option to dequeue the CSS & JS that was enqueued by other theme or plugins. Just dequeue them to prevent duplicate.
...
This plugin download all files in these folders "css, js, sprites, svgs, webfonts" and also contain these files "LICENSE.txt, attribution.js (for download via GitHub API only)".
